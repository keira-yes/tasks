            ...
            <div className="header__container container">
                <Link to='/'>
                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M34.3757 9.375H11.459V13.5417H34.3757C35.5215 13.5417 36.459 14.4792 36.459 15.625V36.4583H23.959V40.625H40.6257V15.625C40.6257 12.1875 37.8132 9.375 34.3757 9.375Z" fill="#AB54DB" fill-opacity="0.15"/>
